    ...
    <div className="bg-amazonclone-background">
      <div className="min-w-[1000px] max-w-[1500px] m-auto">
        ...
        <div className="grid grid-cols-3 xl:grid-cols-4 -mt-80">
          ...
          <HomePageCard title={'More titles to explore'} img={'../images/home_grid_4.jpg'} link={'Browse Kindle Unlimited'} />
          <HomePageCard title={'Browse Kindle Unlimited'} img={'../images/home_grid_5.jpg'} link={'See more'} />
